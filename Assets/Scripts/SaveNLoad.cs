...
public class SaveNLoad : MonoBehaviour
{
    ...
    public void SaveData()
    {
        ...
        theInven = FindObjectOfType<Inventroy>();
    ...
    public void LoadData()
    {
        if(File.Exists(SAVE_DATA_DIRECTORY + SAVE_FILENAME))
        {
            ...
            {
                theInven.LoadToinven(saveData.invenArrayNum[i],
                                     saveData.invenItemName[i], saveData.invenItemNum[i]);
            }
